...
document.querySelector('.btn-roll').addEventListener('click', function() {
    if (isPlaying) {
        ...
        // Update the result score if the rolled number was NOT a 1
        if(dice !== 1) {
            // Add Score
            roundScore += dice;
...
function nextPlayer() {
    ...
    // Toggling player active screens
    var panelOne = document.querySelector('.player-0-panel');
    var panelTwo = document.querySelector('.player-1-panel');
